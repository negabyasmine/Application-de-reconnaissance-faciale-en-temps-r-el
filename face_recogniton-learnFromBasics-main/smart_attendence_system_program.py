        ...
        if matches[matchIndex] :
            ...
            if name == "MOHAND" :
                ...
                while (nb == 0):
                 ...
                 cv2.waitKey(5000)
                 os.startfile("C:/Users/Hp/Desktop/face_recogniton-learnFromBasics-main/RKale.py")
            ...
            if name == "YASMINE" :
                ...
                while (nb == 0):
                 cv2.imshow('video',frame)
                 cv2.waitKey(5000)
                 os.startfile("C:/Users/Hp/Desktop/face_recogniton-learnFromBasics-main/RKale2.py")
                 nb=nb+1
