...
def createuser():
    ...
    title_grand = Label(framforcreateuser, text="Créate New User : ", font=("arial", 25, "bold"))
    title_grand.place(x=50, y=50)
    label_createusername = Label(framforcreateuser, text="Name", font=("arial", 16, "bold"))
    label_createusername.place(x=50, y=120)
    createuserpassword = Label(framforcreateuser, text="Password", font=("arial", 16, "bold"))
    ...
    btn_createuser = Button(framforcreateuser, text="Create Users", bd=1, font=("arial", 15, "bold"),
                            command=addnewusertotableuser)  # create user button
    btn_createuser.place(x=240, y=430, width="130", height="50")  # user button  place()
    btn_showeuser = Button(framforcreateuser, text="Delete All", bd=1, font=("arial", 15, "bold"),
    ...
    btn_deleteeuser = Button(framforcreateuser, text="Delete User", bd=1, font=("arial", 15, "bold"),
    ...
    x775xssqq = Label(framforcreateuser, text="List of Users : ", font=("arial", 20, "bold"))
...
grosTitre = Label(souframelogin,
                  text=" letecia c'est votre expace caissiére ",
                  font=("Times", 18, "bold"),
                  fg="green")
...
def stokemanage():
    ...
    def addnew_articles():
        files = os.listdir("C:/Users/kam/Desktop/pc/Rkale")
        # C:/Users/MOHSAT/Desktop/Rkale/code
        # C:/Users/usuas/Desktop/Rkale
        if "code" not in files:
            os.mkdir('C:/Users/kam/Desktop/pc/Rkale/code')
        top = Toplevel()
        ...
        name_produitsarticl = Label(top, text="Name :", font=('Times', 12, 'bold'))
    ...
    bouton_ajouter_unroduit = Button(framforstokemanage, text="Add Pack", bd=1,
                                     command=addnew_articles)  # bouton ajouter un nouvel article  #
    bouton_ajouter_unroduit.place(x=135, y=90, width=120, height=30)
    bouton_delete_unroduit = Button(framforstokemanage, text="Supprimer le PACK", bd=1,
                                    command=delleteselectedfileintree02)  # bouton supprimer un nouvel article
    bouton_delete_unroduit.place(x=10, y=125, width=120, height=30)
    bouton_delete_all = Button(framforstokemanage, text="Delete All article", bd=1,
    ...
    bouton_delete_oneprodect.place(x=10, y=160, width=120, height=30)
    bouton_edit = Button(framforstokemanage, text="Edit article ", bd=1,
                         command=editfunction_article)  # bouton supprimer un nouvel article
    bouton_edit.place(x=10, y=90, width=120, height=30)
    bouton_edit = Button(framforstokemanage, text="Edit Pack ", bd=1,
                         command=edit_function_pack)  # bouton supprimer un nouvel article
    bouton_edit.place(x=135, y=125, width=120, height=30)
...
###########################################################manuel add articl ########################################################################################
    def xoxoadd_new_article_boutton():
        myfiles = os.listdir("C:/Users/kam/Desktop/pc/Rkale")
    ...
    # --------------------------------------------------------------------------------------------------------------------------------------------------------------------
    Lbl_Namex01 = Label(frame_foradd_nw_articl, text="name", font=('arial', 12, 'bold'))
    ...
    # --------------------------------------------------------------------------------------------------------------------------------------------------------------------
    Lbl_Namex06 = Button(frame_foradd_nw_articl, text="Add  ", command=xoxoadd_new_article_boutton)
...
# searching ---------------------------------------------------------------------------------------------------------
    ...
    btn_forsearch = Button(framforstokemanage, text="Find by name", bd=1, command=serach_by_name778)
    btn_forsearch.place(x=10, y=55, width=120, height=30)
    search_product_labelbycb = Label(framforstokemanage, text="Search:", font=('Times', 12, 'bold'))
    ...
    btn_forsearchbycb = Button(framforstokemanage, text="Find by Barcode", bd=1, command=serach_by_barrecode778)
    btn_forsearchbycb.place(x=135, y=55, width=120, height=30)
    mydb = sqlite3.connect("mydatabase.db")
    cur = mydb.cursor()
    ...
    frm_forserachbydate = Frame(framforstokemanage , height = 150 , width=900 )
    frm_forserachbydate.place(x= 270 , y= 540)
    lbl01 = Label(frm_forserachbydate,text="Filtrage Par Date " , font =("arial", 16 , "bold"))
    lbl01.place(x= 10 , y= 10)
    lbl010 = Label(frm_forserachbydate,text="Du" , font =("arial", 14))
    lbl010.place(x= 10 , y= 50)
    ...
    combo12.current(17)
    combo12.place(x=50, y=50, width="49", height="28.5")
    #--------------------------------------------------------------------------------------------------------------------------------
    ...
    combo14.current(5)
    combo14.place(x=99, y=50, width="110", height="28.5")
    #--------------------------------------------------------------------------------------------------------------------------------
    ...
    combo15.current(21)
    combo15.place(x=209, y=50, width="100", height="28.5")
    #--------------------------------------------------------------------------------------------------------------------------------
    #--------------------------------------------------------------------------------------------------------------------------------
    #--------------------------------------------------------------------------------------------------------------------------------
    #--------------------------------------------------------------------------------------------------------------------------------
    ...
    lbl016 = Label(frm_forserachbydate,text=" Ou  " , font =("arial", 14))
    lbl016.place(x= 325 , y= 50)
    ...
    combo12x.current(18)
    combo12x.place(x=380, y=50, width="49", height="28.5")
    #--------------------------------------------------------------------------------------------------------------------------------
    ...
    combo14x.current(5)
    combo14x.place(x=429, y=50, width="110", height="28.5")
    #--------------------------------------------------------------------------------------------------------------------------------
    ...
    combo15x.current(21)
    combo15x.place(x=539, y=50, width="100", height="28.5")
    boutn_pour_filtrage4lo = Button(frm_forserachbydate ,text="Filtre Par Packs",  bd=0, bg="#FA8072",fg="#FFFFFF" ,font=('arial' , 10 ,'bold'),command=filtre_between )
    boutn_pour_filtrage4lo.place(x = 650 , y = 46 , height=35 ,width =120 )
    boutn_pour_filtrage4lo = Button(frm_forserachbydate ,text="Filtre Par Articles",  bd=0, bg="#FA8072",fg="#FFFFFF" ,font=('arial' , 10 ,'bold'),command=filtre_between_article )
    boutn_pour_filtrage4lo.place(x = 780 , y = 46 , height=35 ,width =120 )
    mydb = sqlite3.connect('mydatabase.db')
    cur = mydb.cursor()
...
def modecaisserkale():
    ...
    def nouveau_panier_bs():
        ...
        Labeltotaldescourse = Label(framesousmodecaisse , text = "Total : " + str(sumtotal_du) + " DA" ,bg="#059862",fg="#FFFFFF",font="arial 20 bold")
    ...
    lbhnjhb = Label(framesousmodecaisse , text="Monnaie Rapide",bg="#007BF7",fg="#FFFFFF",font="arial 11 bold")
    lbhnjhb .place(x =730 , y = 10 ,height=25 , width=240)
    ...
    ajouterdelaquantitBUTTON = Button(framesousmodecaisse , text="+",font=('arial 25 bold'), bd=0 ,bg="#059862",fg="#FFFFFF",command=add_simillarrarticles_852)
    ajouterdelaquantitBUTTON.place(x =374 , y = 410, width=40 , height=60)
